Contributing to coin1tx Core
============================

The coin1tx Core project operates an open contributor model where anyone is
...
The following applies to code changes to the coin1tx Core project, and is not to be
confused with overall coin1tx Network Protocol consensus changes.

Whether a pull request is merged into coin1tx Core rests with the project merge
...
Patches that change coin1tx consensus rules are considerably more involved than
...
Where a patch set proposes to change the coin1tx consensus, it must have been
...
The project leader is the release manager for each coin1tx Core release.
